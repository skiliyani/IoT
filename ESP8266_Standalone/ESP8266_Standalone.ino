...
char auth[] = "f14225c4268e4c77a14036283a0e3805";

// Your WiFi credentials.
// Set password to "" for open networks.
char ssid[] = "SAYANI_IOT";
char pass[] = "00001111";
...
void emailOnButtonPress()
{
  ...
  if (isButtonPressed) // You can write any condition to trigger e-mail sending
  {
    ...
    //Blynk.email("kiliyani.sajeesh@gmail.com", "Subject: Button Logger", "You just pushed the button...");
...
void setup()
{
  ...
  Blynk.email("Blynk", "My Blynk project is online.");
